...
<body class="bg-gray-100 flex items-center justify-center h-screen bg-purple-100">
    ...
    <form action="index.php" method="POST" class="bg-white p-8 rounded-lg shadow-md w-96">
        ...
        <p class="text-center text-gray-500 text-sm mt-4">Vous avez déjà un compte ? <a href="login.php" class="text-blue-500 hover:underline">Connexion</a></p>
    </form>
