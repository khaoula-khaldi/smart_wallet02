...
$categoriesObj = new categoriesIn($pdo);
...
<body class=" flex flex-col gap-5 font-sans text-gray-800 bg-purple-100">
        ...
        <section class="border border-gray-200 p-4 rounded-xl shadow-sm bg-blue-100">
          ...
          <form method="POST" action="incomes.php" class="flex flex-col gap-3">
              ...
              <div class="flex gap-3">
                  ...
                  <input type="date" name="dateIn" class="border border-gray-300 p-2 rounded w-1/4" required>
              </div>
...
<?php 
            ...
            $income = new Incomes($pdo);
            $income->createIn($MontantIn,$descreptionIn,$dateIn,$category_id,$user_id);
            }
